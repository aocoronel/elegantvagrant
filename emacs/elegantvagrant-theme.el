...
(custom-theme-set-faces
   ...
   ;; Eglot
   `(eglot-semantic-defaultLibrary  ((t (:foreground ,peach))))
   `(eglot-semantic-operator        ((t (:foreground ,white))))
   `(eglot-semantic-definition      ((t (:foreground ,white))))
   `(eglot-semantic-declaration     ((t (:foreground ,white))))
   `(eglot-semantic-enum            ((t (:foreground ,teal))))
   `(eglot-semantic-enumMember      ((t (:foreground ,teal))))
   `(eglot-semantic-readonly        ((t (:foreground ,teal))))
   `(eglot-semantic-number          ((t (:foreground ,peach))))
   ;; `(eglot-semantic-namespace		((t (:foreground ,white))))
   ;; `(eglot-semantic-type				((t (:foreground ,white))))
   ;; `(eglot-semantic-class			((t (:foreground ,white))))
   ;; `(eglot-semantic-interface		((t (:foreground ,white))))
   ;; `(eglot-semantic-struct			((t (:foreground ,white))))
   ;; `(eglot-semantic-typeParameter	((t (:foreground ,white))))
   ;; `(eglot-semantic-parameter		((t (:foreground ,white))))
   ;; `(eglot-semantic-variable			((t (:foreground ,white))))
   ;; `(eglot-semantic-property			((t (:foreground ,white))))
   ;; `(eglot-semantic-event			((t (:foreground ,white))))
   ;; `(eglot-semantic-function			((t (:foreground ,white))))
   ;; `(eglot-semantic-method			((t (:foreground ,white))))
   ;; `(eglot-semantic-macro			((t (:foreground ,white))))
   ;; `(eglot-semantic-keyword			((t (:foreground ,white))))
   ;; `(eglot-semantic-modifier			((t (:foreground ,white))))
   ;; `(eglot-semantic-comment			((t (:foreground ,white))))
   ;; `(eglot-semantic-string			((t (:foreground ,white))))
   ;; `(eglot-semantic-regexp			((t (:foreground ,white))))
   ;; `(eglot-semantic-decorator		((t (:foreground ,white))))
   ;; `(eglot-semantic-static			((t (:foreground ,white))))
   ;; `(eglot-semantic-deprecated		((t (:foreground ,white))))
   ;; `(eglot-semantic-abstract			((t (:foreground ,white))))
   ;; `(eglot-semantic-async			((t (:foreground ,white))))
   ;; `(eglot-semantic-modification		((t (:foreground ,white))))
   ;; `(eglot-semantic-documentation	((t (:foreground ,white))))
